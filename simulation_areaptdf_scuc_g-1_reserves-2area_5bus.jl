...
sys = System("systems_json/2area_5bus_g-1.json")
...
gens_outages_names_list = [["Alta_1"], ["Park City_2"]] #Add Here the names of the generators to be considered for outages in the G-k formulation
